---
sidebar_position: 2
title: روبوٹکس کے لیے Reinforcement Learning
description: آزمائش اور خطا کے ذریعے روبوٹ کے رویے سیکھنا
---
...
- روبوٹکس کے لیے reinforcement learning کی بنیادی باتوں کو سمجھنا
- Q-learning اور policy gradient طریقے سیکھنا
- Deep RL الگورتھمز (DQN، PPO، SAC) نافذ کرنا
- روبوٹ کی نقل و حرکت اور ہیرا پھیری کے کاموں پر RL کا اطلاق کرنا

## روبوٹکس کے لیے RL کا تعارف

Reinforcement Learning روبوٹس کو ماحول کے ساتھ تعامل کے ذریعے رویے سیکھنے کے قابل بناتا ہے۔ supervised learning کے برعکس، RL لیبل شدہ مثالوں کی بجائے انعامات سے سیکھتا ہے۔
...
| تصور | تفصیل | روبوٹکس مثال |
|---------|-------------|------------------|
| State (s) | روبوٹ کی موجودہ صورتحال | جوائنٹ کے زاویے، اشیاء کی پوزیشنیں |
| Action (a) | روبوٹ کیا کر سکتا ہے | موٹر کمانڈز، گریپر کھولنا/بند کرنا |
| Reward (r) | فیڈ بیک سگنل | کامیاب گرفت کے لیے +10، تصادم کے لیے -1 |
| Policy (π) | ایکشن کے انتخاب کی حکمت عملی | states کو actions سے منسلک کرنے والا نیورل نیٹ ورک |
| Value Function (V) | متوقع مستقبل کا انعام | یہ روبوٹ کنفیگریشن کتنی اچھی ہے؟ |

## Markov Decision Process (MDP)

روبوٹکس کے مسائل MDPs کے طور پر تشکیل دیے جاتے ہیں:
...
ایکشن ویلیو فنکشن Q(s, a) سیکھیں:
...
Q-learning کو اعلیٰ جہتی states تک بڑھائیں:
...
جدید ترین policy gradient طریقہ:
...
:::tip خلاصہ
- **RL فریم ورک**: ایجنٹ ماحول کے ساتھ تعامل کے ذریعے انعامات سے سیکھتا ہے
- **MDPs** روبوٹ کے فیصلہ سازی کے مسائل کو باضابطہ بناتے ہیں
- **Q-learning** ایکشن ویلیو فنکشنز سیکھتا ہے (discrete actions)
- **DQN** ڈیپ نیٹ ورکس اور تجربہ ری پلے کے ساتھ Q-learning کو بڑھاتا ہے
- **Policy gradients** براہ راست policy پیرامیٹرز کو بہتر بناتے ہیں
- **PPO** روبوٹ لرننگ کے لیے موجودہ جدید ترین طریقہ ہے
:::

## مشق کی مشقیں

1. **Q-Learning Navigation**: گرڈ ورلڈ نیویگیشن کے لیے Q-learning نافذ کریں۔

2. **DQN Reaching**: ہدف کی پوزیشنوں تک پہنچنے کے لیے DQN ایجنٹ کو تربیت دیں۔

3. **PPO Locomotion**: PPO استعمال کرتے ہوئے چوپایہ روبوٹ کو چلنے کی تربیت دیں۔

4. **Sim-to-Real**: سیکھی ہوئی پالیسی کو سمولیشن سے حقیقی روبوٹ میں منتقل کریں۔
