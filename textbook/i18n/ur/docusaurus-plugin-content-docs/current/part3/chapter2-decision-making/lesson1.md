---
sidebar_position: 1
title: Task اور Motion Planning
description: اعلیٰ سطح کے اہداف سے موٹر کمانڈز تک روبوٹ کے اعمال کی منصوبہ بندی
---

# Task اور Motion Planning

## سیکھنے کے مقاصد

- روبوٹکس میں منصوبہ بندی کے درجہ بندی کو سمجھنا
- کلاسیکی motion planning الگورتھمز (RRT، A*) سیکھنا
- PDDL کے ساتھ task سطح کی منصوبہ بندی نافذ کرنا
- پیچیدہ رویوں کے لیے task اور motion planning کو جوڑنا

## منصوبہ بندی کا درجہ بندی

روبوٹ کی منصوبہ بندی متعدد سطحوں پر کام کرتی ہے:
