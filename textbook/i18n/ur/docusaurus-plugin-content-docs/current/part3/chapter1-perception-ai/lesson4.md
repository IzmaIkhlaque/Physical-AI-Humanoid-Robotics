---
sidebar_position: 4
title: تقریر اور آڈیو ادراک
description: روبوٹس کو بولی جانے والی زبان سننے اور سمجھنے کے قابل بنانا
---

# تقریر اور آڈیو ادراک

## سیکھنے کے مقاصد

- روبوٹکس کے لیے آڈیو سگنل پروسیسنگ کو سمجھنا
- تقریر کی شناخت کی تکنیکوں اور APIs سیکھنا
- روبوٹ کنٹرول کے لیے آواز کمانڈ سسٹم نافذ کرنا
- حقیقی ماحول میں شور اور متعدد بولنے والوں سے نمٹنا

## روبوٹ سماعت کا تعارف

آڈیو ادراک روبوٹ کی صلاحیتوں کو بصری سینسنگ سے آگے بڑھاتا ہے۔ روبوٹس کر سکتے ہیں:
- بولے گئے احکامات سمجھنا
- ماحولیاتی آوازوں کا پتہ لگانا (الارم، دروازے کی گھنٹیاں)
- آواز کے ذرائع کو مقامی بنانا
- بولنے والوں کی شناخت کرنا
...
### مقامی شناخت کے لیے Whisper کا استعمال
...
تقریر کو روبوٹ کمانڈز میں تبدیل کریں:
...
## آواز کے ذریعہ کی لوکلائزیشن

آوازیں کہاں سے آتی ہیں اس کا تعین کریں:
...
:::tip خلاصہ
- **آڈیو پروسیسنگ** میں فلٹرنگ، فیچر نکالنا (MFCC)، اور VAD شامل ہے
- **تقریر کی شناخت** Whisper جیسے ماڈلز استعمال کرتے ہوئے آڈیو کو ٹیکسٹ میں تبدیل کرتی ہے
- **Intent کی شناخت** ٹیکسٹ کو قابل عمل روبوٹ کمانڈز میں parse کرتی ہے
- **آواز کمانڈ سسٹم** VAD، ASR، اور intent parsing کو جوڑتے ہیں
- **آواز کی لوکلائزیشن** آواز کے ذرائع تلاش کرنے کے لیے مائیکروفون arrays استعمال کرتی ہے
- حقیقی ماحول میں **شور اور متعدد بولنے والوں** سے نمٹیں
:::

## مشق کی مشقیں

1. **آواز سے کنٹرول شدہ روبوٹ**: بنیادی آواز کمانڈز کا جواب دینے والا سسٹم بنائیں۔

2. **Keyword Spotting**: اپنے روبوٹ کے لیے wake word ڈیٹیکشن نافذ کریں۔

3. **آواز کی لوکلائزیشن**: ایک مائیکروفون array سیٹ اپ کریں اور آواز کی سمت کا اندازہ لگائیں۔

4. **کثیر لسانی سپورٹ**: سسٹم کو متعدد زبانوں کو سنبھالنے کے لیے بڑھائیں۔
